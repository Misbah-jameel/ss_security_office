...
// import { useEffect, useRef, useState } from 'react'
// import { Award, Users, Zap, Shield, Car, Star } from 'lucide-react'
...
//   const benefits = [
//     { icon: Award, title: 'PERSONAL BODY GUARDS', image: '/bod_1.jpeg', description: 'We provide trained personal body guards with heavy weapons for complete protection.' },
//     { icon: Users, title: 'BOUNCERS', image: '/bod_2.jpeg', description: 'Professional bouncers for events to manage and control every situation smartly.' },
//     { icon: Zap, title: 'PROTOCOL GUARDS', image: '/bod_3.jpeg', description: 'Highly trained protocol guards with advanced security services.' },
//     { icon: Shield, title: 'ARMED SECURITY', image: '/bod_4.jpeg', description: 'Expert armed security staff for commercial and residential protection.' },
//     { icon: Car, title: 'SECURITY VEHICLES', image: '/bod_5.jpeg', description: 'Fully equipped patrol and escort vehicles available on demand.' },
//     { icon: Star, title: 'VIP PROTECTION', image: '/bod_7.jpeg', description: 'Top-level VIP protection with experienced and skilled personnel.' },
//   ]
...
//             We <span className="text-primary">Proud Our Services</span>
//           </h2>
//           <p className="text-foreground/70 text-lg max-w-3xl mx-auto mt-4">
//             Our ambition is to provide well trained personnel and high quality services.
//           </p>
//         </div>
...
//               <div
//                 key={index}
//                 className="group bg-card border border-border rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-500 hover:-translate-y-2"
//               >
//                 {/* Image */}
              ...
              >
                ...
                <div className="relative w-full">
                  <Image
                    ...
                    height={300}  // adjust for natural ratio
